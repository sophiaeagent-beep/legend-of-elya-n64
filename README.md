...
## Personality Packs (community contribution)

Bounty #6 delivered a training pipeline that produces four distinct NPC weight
bundles (Sophia, blacksmith, librarian, guard) from tagged persona datasets.
The pipeline, datasets, and evaluation reports live in this repo:

- [docs/PERSONALITY_PACK.md](docs/PERSONALITY_PACK.md): full pipeline documentation (written in Chinese by the contributor)
- [COMPLETION_REPORT.md](COMPLETION_REPORT.md): evaluation results
- `data/personas.yaml`, `data/training_data.json`: persona datasets
- `weights/`: per-personality weight files
